...
class OnboardingEmbedder:
    ...
    def __init__(self, chroma_persist_dir: str = "./chroma_db", base_path: str = "onboarding"):
        """Initialize ChromaDB client and collection with OpenAI embeddings

        base_path: relative path where merged configs and projects live (defaults to backend/onboarding)
        """
    ...
    def embed_project(self, project_name: str, config_path: str = None) -> Dict[str, Any]:
        ...
        if config_path:
            ...
            # Prefer base_path/projects/{project_name}/merged_config.json
            path = self.base_path / 'projects' / project_name / 'merged_config.json'
